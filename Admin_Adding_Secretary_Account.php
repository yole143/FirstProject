<?php
    ...
    if (isset($_POST['add'])){
        ...
        $checktitle = mysqli_num_rows(mysqli_query($conn, "SELECT research FROM admin_data WHERE research='$research'"));
        
        if ($checktitle==0){
            $sql = "INSERT INTO admin_data (research, authors, status, proposed, started, completed)
            Values ('$research','$authors','$status', '$proposed','$started','$completed')";
            ...
            echo "<script>alert('Research Title is already Exist');</script>";
        }
...
<html>
    ...
    <body>
        <div class="Add">
        <span><a href="Admin_Account.php"><button class="w">Back</button></a></span>
