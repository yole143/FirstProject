<?php
    ...
    if (isset($_POST['login'])){
        ...
        if ($category== "dapitan" ){
            ...
            $sql = "SELECT * FROM author_account WHERE username = '$username' AND password='$password' AND campus = '$category'";
            ...
            if (mysqli_num_rows($result) > 0){
                ...
                header("Location: Author_Account.php");
    ...
    <body>
        ...
        <div class="">
                <div class="container">
                    ...
                    <label for="" class="labelh4">Author Portal</label>
                    <br><br><br><br>
                </div>
                <div class = "border">
